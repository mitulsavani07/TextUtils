    ...
    <div>
      ...
      <div className='flex flex-wrap -mx-4'>
        <div className='lg:w-1/2 w-full px-4'>
          ...
          <textarea className='w-full p-5 rounded-lg dark:text-white dark:drop-shadow-none dark:border-none drop-shadow-primary' cols="30" rows="10" id="input" value={inputValue} onChange={handleInput} />
        </div>
      ...
      <div className='flex flex-wrap mt-10'>
        <div className='lg:w-1/2 w-full space-y-5 -mx-5'>
          <div className='lg:w-1/2 w-full px-5'>
            <label className='mr-5 min-w-[58px] inline-block' htmlFor="find">Find:</label>
            <input id="find" value={findValue} onChange={handleFind} className="bg-white drop-shadow-primary py-2 px-3 rounded-lg dark:text-white dark:drop-shadow-none" />
          </div>
          <div className='lg:w-1/2 w-full px-5'>
            <label className='mr-5 min-w-[58px] inline-block' htmlFor="replace">Replace:</label>
            <input id="replace" value={replaceValue} onChange={handleReplace} className="bg-white drop-shadow-primary py-2 px-3 rounded-lg dark:text-white dark:drop-shadow-none" />
          </div>
        </div>
