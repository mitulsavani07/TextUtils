          ...
          <div className='w-full sm:w-1/2 lg:w-1/3 p-4'>
            <div className='w-full bg-white dark:bg-darksecondary p-5 rounded-lg drop-shadow-primary dark:drop-shadow-none'>
              ...
              <ul className='text-gray pt-4 space-y-3 mt-4'>
                ...
                <li><NavLink to="/split-text" className="flex items-center hover:text-primary"><svg className='mr-4 w-2 h-2' width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="3.79688" r="3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                Split Text</NavLink></li>
                <li><NavLink to="/age-calculator" className="flex items-center hover:text-primary"><svg className='mr-4 w-2 h-2' width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="3.79688" r="3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                Age Calculator</NavLink></li>
                <li><NavLink to="/lorem-ipsum-generator" className="flex items-center hover:text-primary"><svg className='mr-4 w-2 h-2' width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="3.79688" r="3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                Lorem Ipsum Generator</NavLink></li>
                <li><NavLink to="/text-to-speech" className="flex items-center hover:text-primary"><svg className='mr-4 w-2 h-2' width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="3.79688" r="3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                ...
                <li><NavLink to="/age-compare" className="flex items-center hover:text-primary"><svg className='mr-4 w-2 h-2' width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="4" cy="3.79688" r="3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
                Age Compare</NavLink></li>
              </ul>
            </div>
          </div>
          <div className='w-full sm:w-1/2 lg:w-1/3 p-4'>
